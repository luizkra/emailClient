...
const Content = ({ mailViewer, actionButons, current, viewList }) => {
        ...
        <div className="contentBody">
          <header>
            <div className="left-menu-header">
              <div className="">
                {viewList !== 'Trash' && <ButtonCustom
                  customClass={'deleteMailButton'}
                  textBtn='Delete'
                  click={() => actionButons(current.idMail, 'MOVE_TO_TRASH', mailViewer, viewList)}
                />}
              </div>
              <div className="">
                {viewList !== 'Spam' && <ButtonCustom
                  customClass={'spamMailButton'}
                  textBtn='Spam'
                  click={() => actionButons(current.idMail, 'MOVE_TO_SPAM', mailViewer, viewList)}
                />}
              </div>
            </div>
            <div className="rigth-menu-header">
              <div className="">
                <ButtonCustom
                  ...
                  click={() => actionButons(current.idMail, 'MOVE_TO_INBOX', mailViewer, viewList)} />
              </div>
            </div>
          </header>
